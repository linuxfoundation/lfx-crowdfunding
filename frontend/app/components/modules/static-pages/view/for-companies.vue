...
// const { data: companiesData, isLoading: companiesLoading, error: companiesRawError } = useInvestingCompanies();
// const companiesError = computed(() => companiesRawError.value as Error | null);
</script>

<script lang="ts">
export default {
  name: 'ForCompaniesView',
};
</script>
